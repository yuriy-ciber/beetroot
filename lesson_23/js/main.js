...
// let message = (userNumber == 0) ? 'Symbol is )' :
...
// let message = (isNaN(threeNumber))?'This is not a number':
...
// let message = (isNaN(userYear)) ? 'This is not a number' :
...
// let result = (diametrCircle == sideSquare) ? ('The circle inside the square') :
